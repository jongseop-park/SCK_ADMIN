            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">회원 계정관리</h6>
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                <li class="breadcrumb-item"><a href="/"><i class="fas fa-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="/account/member/list?page=1&perPageNum=10&searchType=전체보기&keyword=">회원 계정관리</a></li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card-header bg-dark">
                        ...
                        <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" style="float: right" method="get">
                            <select class="custom-select mr-sm-3" style="color: black;" id="searchSelect" name="searchType">
                                ...
                                <option value="cn" <c:out value="${conn.searchType == 'cn' ? 'selected' : ''}"/>>제목/관리자</option>
                                <option value="ac" <c:out value="${conn.searchType == 'ac' ? 'selected' : ''}"/>>제목</option>
                                <option value="an" <c:out value="${conn.searchType == 'an' ? 'selected' : ''}"/>>관리자</option>
                            </select>
                        ...
                        <nav aria-label="...">
                            <ul class="pagination justify-content-center mb-0">
                                <c:if test="${paging.prev}">
                                    <li class="page-item">
                                        <a class="page-link" href="/master/member/list${paging.makeSearch(paging.startPage - 1)}" tabindex="-1">
                                ...
                                <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="idx">
                                    <li class="page-item" id="page${idx}">
                                        <a class="page-link" href="/master/member/list${paging.makeSearch(idx)}" >${idx}</a>
                                    </li>
                                </c:forEach>
                                <c:if test="${paging.next && paging.endPage > 0}">
                                    <li class="page-item">
                                        <a class="page-link" href="/master/member/list${paging.makeSearch(paging.endPage+1)}">
