            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">메인</h6>
...
<!-- Optional JS -->
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5ec59fd5e241d96bae5017083c773422&libraries=services"></script>
...
<script type="text/javascript">
    $(document).ready(function () {
        var mapContainer = document.getElementById('map'), // 지도의 중심좌표
            mapOption = {
                center: new kakao.maps.LatLng(37.501379, 126.940096), // 지도의 중심좌표
                level: 3 // 지도의 확대 레벨
            };
...
// 지도에 마커를 표시합니다
        var marker = new kakao.maps.Marker({
            map: map,
            position: new kakao.maps.LatLng(37.501379, 126.940096)
        });
        ...
        var content =
            ...
            '<div class="jibun ellipsis">(우) 06962 (지번) 동작구 상도동 204-344</div>' +
            '<div><a href="http://localhost:16000/" target="_blank" class="link">홈페이지</a></div>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>';
