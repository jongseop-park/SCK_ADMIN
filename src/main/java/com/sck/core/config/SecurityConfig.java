...
import com.sck.core.handler.CustomAuthFailureHandler;
import com.sck.core.handler.CustomAuthSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                // 페이지 권한 설정
                    ...
                    .antMatchers("/account/**/form").hasRole("MASTER")
                    .antMatchers("/**").access("hasRole('MASTER') OR hasRole('ADMIN')")
    ...
    @Bean
    public AuthenticationSuccessHandler successHandler() { // 성공처리 핸들러
        return new CustomAuthSuccessHandler();
    }

    @Bean
    public AuthenticationFailureHandler failureHandler(){ // 실패처리 핸들러러
